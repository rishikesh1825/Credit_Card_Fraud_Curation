...
## 📊 Dataset Context
The data utilized in this project simulates European credit card transactions. Due to GitHub's file size constraints, the raw `creditcard.csv` dataset is not hosted in this repository. 

**To run this project locally:**
1. Download the dataset directly from [Kaggle's Credit Card Fraud Detection page](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud).
2. Extract the `creditcard.csv` file into the root directory of this cloned repository. 
3. Run `app.py`.
